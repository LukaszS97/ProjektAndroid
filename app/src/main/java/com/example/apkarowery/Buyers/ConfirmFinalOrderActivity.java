...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Całkowita cena = $ " + totalAmount, Toast.LENGTH_SHORT).show();
    ...
    private void Check() {
        if (TextUtils.isEmpty(nameEditText.getText().toString())) {
            ...
            Toast.makeText(this, "Podaj numer", Toast.LENGTH_SHORT).show();
                ...
                if (task.isSuccessful()) {
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(ConfirmFinalOrderActivity.this, "Twoje zamówienie zostało zrealizowane", Toast.LENGTH_SHORT).show();
