...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProxessBtn = (Button) findViewById(R.id.next_process_btn);
        txtTotalAmount = (TextView) findViewById(R.id.total_price);

        txtMsg1 = (TextView) findViewById(R.id.msg1);

        NextProxessBtn.setOnClickListener(new View.OnClickListener() {
            @Override
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(CartActivity.this, "Rower usunięty.", Toast.LENGTH_SHORT).show();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        NextProxessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this, "Będziesz mógł dodać więcej rowerów do koszyka jeśli twoje poprzednie zamówienie zostanie zrealizowane", Toast.LENGTH_SHORT).show();

                    } else if (shippingState.equals("not shipped")) {
                        txtTotalAmount.setText("Status - W Oczekiwaniu");
                        recyclerView.setVisibility(View.GONE);
